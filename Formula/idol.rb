class Idol < Formula
    ...
    on_macos do
        url "https://github.com/hlefebvr/idol/releases/download/0.10.2/idol-0.10.2-macos-arm64.tar.gz"
        sha256 "974b4c61254073f27ceaf9ee5bd7df1d51afe6de8fe753746045f1a951c32a52"
        version "0.10.2"
    end
