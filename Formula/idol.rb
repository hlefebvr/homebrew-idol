class Idol < Formula
    ...
    on_macos do
        url "https://github.com/hlefebvr/idol/releases/download/0.9.6/idol-0.9.6-macos-arm64.tar.gz"
        sha256 "41f95577aabe4ee72c9bfbbcc6a1f9cc0818ac12b8575e2da6a7a6d221decde9"
        version "0.9.6"
    end
