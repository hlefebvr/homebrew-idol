class Idol < Formula
    ...
    on_macos do
        url "https://github.com/hlefebvr/idol/releases/download/0.9.3/idol-0.9.3-macos-arm64.tar.gz"
        sha256 "6b2b618834573b14e15a0cd9a0dd0d3b79e7ae981b40c7d7fd41b47304390fdb"
        version "0.9.3"
    end
