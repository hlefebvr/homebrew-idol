class Idol < Formula
    ...
    on_macos do
        url "https://github.com/hlefebvr/idol/releases/download/0.10.6/idol-0.10.6-macos-arm64.tar.gz"
        sha256 "7279f6bbf753504637dc2523ddd2b5efc0f30260724939489becff19f05886ea"
        version "0.10.6"
    end
