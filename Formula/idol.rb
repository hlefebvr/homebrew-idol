class Idol < Formula
    ...
    on_macos do
        url "https://github.com/hlefebvr/idol/releases/download/0.10.7/idol-0.10.7-macos-arm64.tar.gz"
        sha256 "5cc23500b695eaef93a9b9d66030ad19f1bf06bb37b6e2920fb188230ee04eec"
        version "0.10.7"
    end
