class Idol < Formula
    ...
    on_macos do
        url "https://github.com/hlefebvr/idol/releases/download/0.9.5/idol-0.9.5-macos-arm64.tar.gz"
        sha256 "5c11adc4282182fd583db388dc8a41046304ae4de719da0b4e9620da092f12f9"
        version "0.9.5"
    end
